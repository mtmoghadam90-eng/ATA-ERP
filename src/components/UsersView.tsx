...
export default function UsersView({ users, settings, currentUser, addUser, updateUser, deleteUser }: UsersViewProps) {
  ...
  const moduleList = [
    ...
    { id: 'supplierInquiries', name: 'استعلام از تأمین‌کنندگان', desc: 'ثبت استعلام قیمت، مقایسه آفرها و انتخاب آفر برنده تامین‌کنندگان' },
    ...
    { id: 'rates', name: 'نرخ ارز روزانه', desc: 'ثبت نرخ‌های تبدیل ارز به صورت لحظه‌ای' },
